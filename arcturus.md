...
### An update regarding my status with p5.js (2024)


I decided to give p5.js a chance ("Pomegranate"). While there was far less boilerplate needed to set up a sketch and load shaders, it was clear from 1.) the sound of my computer's fan, 2.) the lag of the sketch on mobile browsers and 3.) the very high task manager CPU/"GPU" usage that this was a much less efficient way of running shader-based sketches. Further, I wasn't able to implement ping-pong (frame buffer object) rendering. Needless to say, three.js isn't going away anytime soon...
